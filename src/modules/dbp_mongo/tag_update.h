...
class tag_update_exception: public dbp::exception {
public:
	tag_update_exception(const std::string &msg): dbp::exception(msg) { }
};

class tag_update: public tag_impl {
public:
	tag_update(const std::string &tag_name = ""): tag_impl(tag_name) { };
